...
# 350 filesnames, each file a different spectrum
filenames = np.array(glob.glob("EMILES_PADOVA00_BASE_CH_FITS/Ech*.fits"))
...
star_temps = np.zeros((53689, n_ages, n_mets))

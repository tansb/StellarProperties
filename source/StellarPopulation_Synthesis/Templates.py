...
class Synthetic_Templates(Templates):
    ...
    def __init__(self, model='MILES', light_weighted=False):
        ...
        if model == 'MILES':
            lib_dir    = pwd + ('/../../data/MILES_FSF_files/'
                                'MILES_BASTI_CH_baseFe/')
            array_path = pwd + ('/../../data/MILES_FSF_files/'
                                'MILES_all_data_3D.npy')
            age_grid_path = pwd + ('/../../data/MILES_FSF_files/'
                                   'MILES_age_grid.npy')
            met_grid_path = pwd + ('/../../data/MILES_FSF_files/'
                                   'MILES_met_grid.npy')
            ...
            lib_dir    = pwd + ('/../../data/EMILES_FSF_files/'
                                'EMILES_PADOVA00_BASE_CH_FITS/')
            array_path = pwd + ('/../../data/EMILES_FSF_files/'
                                'EMILES_all_data_3D.npy')
            age_grid_path = pwd + ('/../../data/EMILES_FSF_files/'
                                   'EMILES_age_grid.npy')
            met_grid_path = pwd + ('/../../data/EMILES_FSF_files/'
                                   'EMILES_met_grid.npy')
            ...
            top_lib = pwd + ('/../../data/EMILES-IR_FSF_files/')
            ...
            lib_dir    = pwd + ('/../../data/BPASS_FSF_files/'
                                'singular_spec_files/')
            array_path = pwd + ('/../../data/BPASS_FSF_files/'
                                'BPASS_all_data_4D.npy')
            age_grid_path = pwd + ('/../../data/BPASS_FSF_files/'
                                   'BPASS_age_grid.npy')
            met_grid_path = pwd + ('/../../data/BPASS_FSF_files/'
                                   'BPASS_met_grid.npy')
